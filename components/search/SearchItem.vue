      ...
      <table class="w-full">
        <thead>
          <tr>
            ...
            <th class="text-gray-300 text-left pb-2.5">
              <span class="text-xs leading-tight font-normal">
                Quantity (pcs)
              </span>
            </th>
        ...
        <tbody>
          <tr>
            ...
            <td class="text-[13px] leading-tight text-right pb-[5px] md:pb-2">
              $150,00
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td
              class="text-[13px] leading-tight md:opacity-0 md:pointer-events-none lg:opacity-100 lg:pointer-events-auto"
            >
              Minimum Order: 1
            </td>
