    ...
    <div class="flex items-start">
      ...
      <div>
        <div class="md:flex md:items-center md:mb-[14px] max-w-[480px]">
          ...
          >
                        <span
                            class="text-[15px] leading-tight font-medium mr-2 relative overflow-hidden text-ellipsis whitespace-nowrap">
    ...
    <div class="lg:pr-[75px]">
      <div class="flex">
        <div class="flex flex-col items-start min-w-fit gap-2 xl:gap-1.5">
          ...
          <span
              class="hidden text-[13px] leading-tight text-neutral-700 font-normal mr-[15px] md:inline"> Multiple: 1 </span>
