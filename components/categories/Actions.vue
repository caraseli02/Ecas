    ...
    <template v-if="selectedCategories.length === 0">
      <section class="flex">
        <div class="w-[374px]">
          <UiButton
            variant="ghost"
            class="w-fit justify-start ml-16"
        ...
        <UiAlertDialog>
          <UiAlertDialogTrigger as-child>
            <UiButton
              ...
              variant="secondary"
              size="sm"
              :disabled="selectedCategories.length === 0 || isLocked"
            >
          ...
          <UiAlertDialogContent>
            ...
            <UiAlertDialogFooter>
              ...
              <UiAlertDialogAction @click="deleteCategories(selectedCategories)">
                Continue
              </UiAlertDialogAction>
            </UiAlertDialogFooter>
          </UiAlertDialogContent>
