...
v-if="showAvatar"
          ...
          <Tooltip
              v-if="item.adminSettings?.discount && showDiscount" :position="index === 0 ? 'bottom' : 'top'"
              theme="black">
            <div
                class="border-blue-500 border-[1px] px-2 rounded-[25px] text-xs leading-[1.67] font-semibold text-[#007FFF]">
