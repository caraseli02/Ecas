  ...
  <div class="min-w-[128px] flex justify-between items-center text-neutral-700">
    ...
    <NuxtLink v-if="notes" to="#">
      <UiTooltipProvider>
        <UiTooltip>
          <UiTooltipTrigger>
            <svg class="w-4 h-4 text-slate-500 hover:text-blue-500" width="16" height="16" viewBox="0 0 16 16" fill="none"
              ...
              <path d="M4.6665 5.33301H11.3332" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round" />
              <path d="M4.6665 8.66699H8.6665" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round" />
            </svg>
          </UiTooltipTrigger>
          <UiTooltipContent>
