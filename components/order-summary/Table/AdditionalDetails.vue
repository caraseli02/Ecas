<template>
    <div class="relative px-4 flex flex-row justify-between xl:justify-start xl:gap-6">
        ...
        <button class="relative flex flex-col gap-2 xl:hidden items-center group" @click="emits('likeItem');">
            <HeartSolid v-show="liked" class="absolute top-[1px] text-blue-500" />
