                ...
                <div class="grid grid-cols-1 xl:grid-flow-col xl:gap-[16px] gap-2">
                    <div class="flex flex-row justify-between xl:gap-4 items-center xl:flex-col">
                        ...
                        <div v-if="item.discount.value" class="flex flex-col text-center h-[36px] justify-center">
                            <span class="line-through text-neutral-700 text-sm font-normal leading-5">RON {{
                        ...
                        <div v-else class="flex flex-col text-center h-[36px] justify-center">
                            <span class="text-neutral-700 text-sm font-normal leading-5">RON {{ item.discountPrice
                            }}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row justify-between items-center xl:flex-col xl:gap-4">
                        <span class="text-neutral-700 text-center text-sm font-normal leading-6 xl:gap-4 px-0 xl:px-4">Tax (VAT
                            19%)</span>
                        <div class="flex flex-col text-center h-[36px] justify-center">
                            <span class="text-neutral-700 text-sm font-normal leading-5">RON {{ taxPrice }}</span>
                        </div>
                    </div>
                    <div class="flex flex-row justify-between items-center xl:flex-col xl:gap-4">
                        <span
                        ...
                        <div class="flex flex-col text-center h-[36px] justify-center">
                            <span class="text-neutral-700 text-sm font-normal leading-5">RON {{ subtotal }}</span>
                        </div>
                    </div>
                </div>
            </div>
