  ...
  <div class="bg-[#FFF] rounded-b-lg flex flex-col gap-4 py-4">
        ...
        <div class="grid grid-cols-1 xl:grid-flow-col xl:gap-[16px] gap-2">
          <div class="flex flex-row justify-between xl:gap-4 items-center xl:flex-col">
            ...
            <div v-else class="flex flex-col text-center h-[36px] justify-center">
                            <span class="text-[#222] text-sm font-normal leading-5">RON {{
                                item.discountPrice
                              }}</span>
            </div>
          </div>
    ...
    <div class="relative px-4 flex flex-row justify-between xl:justify-start xl:gap-6">
      ...
      <Transition name="fade-bottom">
        <div
            v-if="showPackagingDetails" v-click-outside="() => (showPackagingDetails = false)"
          ...
          <p class="text-[#222] text-xs font-normal leading-5">
            ...
            Tubes ship with the exact number of parts ordered and a rubber plug or plastic peg in each end to prevent
            the parts from sliding out.
          </p>
        </div>
      </Transition>
      <button
      ...
      <Transition name="fade-bottom">
        <div
            v-if="showDeliveryDetails" v-click-outside="() => (showDeliveryDetails = false)"
      ...
      <button class="flex flex-col gap-2 xl:hidden items-center group" @click="deleteItem">
