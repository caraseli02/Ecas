<template>
  <span class="items-start shadow-sm bg-white flex max-w-[358px] flex-col px-4 py-5 rounded-xl"><span
    ...
    <div class="text-zinc-800 text-sm font-medium leading-6 self-stretch mt-10">
      Saved cards
    </div>
    <div class="flex flex-col gap-3">
      <OrderSummaryPayByCard view="modal" has-card />
      <OrderSummaryPayByCard view="modal" has-card is-selected isExpired />
      <OrderSummaryPayByCard view="modal" has-card />
    </div>
    <span
      class="justify-center items-stretch self-stretch border border-neutral-300 bg-white flex w-full flex-col mt-4 px-3 py-2 rounded-lg border-dashed"><span
        class="items-center flex justify-between gap-3">
        <div
          class="justify-center items-center border-[color:var(--Foundation-E-Grey-e-grey-300,#D3D3D3)] flex w-[18px] shrink-0 h-[18px] flex-col my-auto rounded-[100px] border-2 border-solid">
        </div>
    ...
    </span><span class="items-stretch self-center flex gap-3 mt-10">
      ...
      <div class="text-zinc-800 text-sm leading-6 self-center grow whitespace-nowrap my-auto">
        Secure credit card payment
      </div>
    </span>
    <div class="justify-center items-center self-stretch bg-sky-500 flex w-full flex-col mt-10 px-16 py-2 rounded-lg">
      <span class="flex items-center gap-2">
        <div class="text-white text-base font-medium leading-7 grow whitespace-nowrap">
          Continue
        </div>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14 8L18 12M18 12L14 16M18 12L6 12" stroke="white" stroke-width="1.5" stroke-linecap="round"
