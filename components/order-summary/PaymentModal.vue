<template>
    <section
        ...
        <div class="flex flex-col gap-3">
            <OrderSummaryNewCard class="mt-8" :is-selected="isNewCardSelectedModal" @click="isNewCardSelectedModal = true"
        ...
        <div class="sticky bottom-0 flex flex-col justify-center items-center w-full justify-self-end bg-white z-10 pb-6">
            <div class="items-stretch self-center flex gap-3 mt-10">
                ...
                <div class="text-zinc-800 text-sm leading-6 self-center grow whitespace-nowrap my-auto">Secure credit card
                    payment</div>
            </div>
            <button
                ...
                <span class="flex items-center gap-2">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 8L18 12M18 12L14 16M18 12L6 12" stroke="white" stroke-width="1.5"
