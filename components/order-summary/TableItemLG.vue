<template>
  <div class="rounded-md shadow-m px-[15px] py-2 font-Inter">
    ...
    >
      ...
      <div>
        <div
          class="mb-1 flex flex-col items-start 2xl:flex-row 2xl:items-center"
        >
        ...
        <div class="flex flex-col 2xl:flex-row 2xl:items-center">
          <div class="text-xs leading-tight mb-[5px] mr-2.5 2xl:mb-0">
      ...
      <div class="flex flex-col font-semibold">
        <span v-if="item.discount" class="text-sm text-gray-300 mb-0.5">
          $150,00
        </span>
        <span :class="[item.discount ? 'text-green mb-2.5' : '']">
          $120,00
        </span>
        <div
          v-if="item.discount"
      ...
      <div class="flex items-center gap-[15px] text-gray-300">
        ...
        <button
          class="flex transition-colors duration-300 hover:text-blue ml-auto"
        >
