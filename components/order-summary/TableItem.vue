<template>
  <div class="rounded-md shadow-card p-[15px]">
    <div class="flex items-start justify-between mb-10">
      <div class="relative flex items-start">
        <img
          :src="item.cover"
          :alt="item.title"
          class="w-[65px] h-[65px] mr-2.5"
        />
        <div>
          <div class="mb-1.5 md:flex md:items-center md:mb-1">
            <div
              class="font-Inter font-semibold leading-tight mb-1.5 md:mb-0 md:mr-2.5"
            >
              {{ item.title }}
            </div>
            <button
          ...
          <div class="text-xs leading-tight truncate mb-1">
            Diode: rectifying; SMD; 100V; 0.15...
          </div>
          <div class="md:flex md:items-center">
            <div class="text-xs leading-tight mb-1.5 md:mb-0 md:mr-2.5">
              Manufacturer: Microchip
            </div>
            <div class="flex items-center text-green">
              <CheckIcon class="w-4 h-4 mr-1" />
              <span class="text-xs leading-tight font-semibold font-Inter">
                16,000 in stock
              </span>
            </div>
          </div>
    ...
    <div class="flex items-end justify-between">
      <div
        class="relative flex flex-col gap-[5px] md:flex-row md:items-center md:gap-[30px]"
      >
        ...
        <div class="flex items-center text-xs font-Inter">
          ...
          <span
            class="flex items-end text-sm font-medium leading-snug md:text-base md:items-center"
          >
            <span
              class=""
              :class="[item.discount ? 'text-green mr-[5px]' : '']"
            >
              $120,00
            </span>
            <span
              v-if="item.discount"
              class="text-xs line-through text-gray-300 md:text-sm"
            >
              $150,00
            </span>
          </span>
        ...
        <div class="flex items-center text-xs font-Inter">
          ...
          <span class="text-sm font-medium leading-snug md:text-base">
            $30.000,00
          </span>
        </div>
        <div
