        ...
        <div v-if="mixedOrBackOrder" class="flex flex-col gap-4">
            <button @click="selectBackorderPreference('Partial')" class="flex flex-row gap-3 items-start group">
                ...
                <div class="flex flex-col items-start">
                    ...
                    <p class="text-neutral-700 text-sm font-normal leading-6 text-start">Backorder items will be shipped as they
                        come in
            ...
            <button @click="selectBackorderPreference('Full')" class="flex flex-row gap-3 items-start group">
                ...
                <div class="flex flex-col items-start">
                    ...
                    <p class="text-neutral-700 text-sm font-normal leading-6 text-start">Wait for backordered items to arrive in
                        stock and
                    ...
                    <div class="flex flex-row gap-3 items-start">
                        ...
                        <div class="flex flex-col items-start">
                            <h2
                                class="text-neutral-700 text-sm font-medium leading-6 group-hover:text-[#007FFF] transition duration-300">
                                Free Delivery</h2>
                            <p class="text-neutral-700 text-sm font-normal leading-6 text-start">3-7 Business Days</p>
                        </div>
                    </div>
                    <span class="text-neutral-700 text-sm font-medium leading-6 group-hover:text-[#007FFF] transition duration-300">$ 0.00</span>
                </button>
                <button @click="selectDeliveryMethod('Standard')" class="flex flex-row justify-between group">
                    <div class="flex flex-row gap-3 items-start">
                        ...
                        <div class="flex flex-col items-start">
                            ...
                            <p class="text-neutral-700 text-sm font-normal leading-6 text-start">3-5 Business Days</p>
                        </div>
                    </div>
                    <span class="text-neutral-700 text-sm font-medium leading-6 group-hover:text-[#007FFF] transition duration-300">$ 5.49</span>
                </button>
                    ...
                    <div class="flex flex-row gap-3 items-start">
                        ...
                        <div class="flex flex-col items-start">
                            <h2
                                class="text-neutral-700 text-sm font-medium leading-6 group-hover:text-[#007FFF] transition duration-300">
                                Express Delivery</h2>
                            <p class="text-neutral-700 text-sm font-normal leading-6 text-start">1-2 Business Days</p>
                        </div>
                    </div>
                    <span class="text-neutral-700 text-sm font-medium leading-6 group-hover:text-[#007FFF] transition duration-300">$ 7.49</span>
                </button>
            </div>
        </div>
    </div>
