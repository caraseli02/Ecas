<template>
  <UiSelect v-model:model-value="selected" :default-value="statuses[0].value">
      ...
      <section class="flex flex-col gap-12 justify-center bg-white">
        <header class="flex flex-col justify-center w-full">
          <div class="flex gap-10 justify-between items-center w-full">
            <h1 class="self-stretch my-auto text-base font-semibold leading-7 text-zinc-800">
              Order Status Update
            </h1>
          </div>
          <div class="flex flex-col self-center mt-12">
            <p class="self-start text-sm leading-none text-center text-zinc-800">
            ...
            <div class="flex gap-4 items-center mt-4 text-2xl leading-none">
              ...
              <strong class="self-stretch my-auto font-medium text-zinc-800">
                S-241030007
              </strong>
            </div>
          </div>
        ...
        <footer class="flex gap-2 md:justify-end items-center mt-12 w-full text-sm font-medium leading-none whitespace-nowrap">
          <UiButton class="min-w-24" variant="secondary" @click="cancelChange">
            Cancel
          </UiButton>
          <UiButton class="w-full min-w-32 md:w-fit" @click="confirmChange">
            Confirm
          </UiButton>
        </footer>
      </section>
