...
<template>
    <UiPopover>
        ...
        <UiPopoverContent class="w-fit flex flex-col gap-2 p-2" align="end">
            ...
            <UiButton class="hover:text-blue-500 justify-start gap-2 min-w-[164px]" variant="ghost" size="sm" @click="isOpen = true">
    ...
    <UiDialog v-model:open="isOpen">
        <UiDialogContent>
            <section data-layername="property1Desktop" class="flex flex-col gap-10 bg-white rounded-xl shadow-sm max-w-[480px]">
                ...
                <form class="flex flex-col mt-10 w-full text-sm" @submit.prevent="handleSubmit">
                    ...
                    <div data-layername="dropDown" class="flex flex-col mt-4 w-full">
                        <label for="paymentDate" data-layername="dropDownDate" class="leading-none text-gray-500">Payment Date</label>
                        <div class="relative">
                            <input
                                id="paymentDate"
                                v-model="paymentDate"
                                type="date"
                                data-layername="48DateTitle"
