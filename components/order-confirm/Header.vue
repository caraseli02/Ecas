...
<template>
  <div class="flex flex-col md:flex-row gap-4 justify-between w-full">
    <section class="flex flex-col gap-4 w-full bg-light-100 md:bg-transparent border md:border-none border-grey-300 p-2 rounded-lg md:rounded-none">
      ...
      <div
        class="flex flex-col xl:flex-row flex-wrap gap-3 pr-20 md:mt-3 lg:mt-0 text-sm leading-6 max-md:flex-wrap max-md:pr-5">
        ...
        <div class="flex gap-2">
          ...
          <div class="text-neutral-700 font-medium">{{ shippingMethod }}</div>
        </div>
        ...
        <div v-if="pickupDate" class="flex gap-2">
          ...
          <div class="text-neutral-700 font-medium">{{ pickupDate }}</div>
        </div>
      </div>
    </section>
