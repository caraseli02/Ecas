    ...
    <section ref="elDOM" class="mb-7 lg:mb-[38px] xl:mb-[58px]">
        <div class="container">
            ...
            >
                <h2 class="hidden text-xl font-semibold md:block">
                    {{
                        ...
                        activeFilter.substr(1).toLowerCase().replace("-", " ")
                    }}
                    products
                </h2>
            ...
            <div class="md:grid md:grid-cols-[auto,1fr] md:gap-5">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                adipiscing elit. Donec sollicitudin accumsan
                                nisi a porttitor.
                            </p>
                            <button
                ...
                >
                    <SwiperSlide
                        v-for="(productGroup, index) in productsMD"
                        :key="index"
                    >
                ...
                >
                    <SwiperSlide
                        v-for="(productGroup, index) in productsLG"
                        :key="index"
                    >
                ...
                >
                    <SwiperSlide
                        v-for="(productGroup, index) in productsXL"
                        :key="index"
                    >
