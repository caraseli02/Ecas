<template>
  <section ref="elDOM" class="mb-7 lg:mb-[38px] xl:mb-[58px]">
    <div class="container px-[11px] md:px-4">
      ...
      >
        <h2 class="hidden text-xl font-semibold md:block">Featured Products</h2>
      ...
      <div class="md:grid md:grid-cols-[auto,1fr] md:gap-5">
        <div class="px-1 md:pt-1 md:pr-0">
          ...
          >
            ...
            />
            <div
              class="flex-1 flex flex-col items-center justify-center text-center xl:items-start"
            >
              <div
                class="font-semibold mb-2.5 md:mb-[30px] lg:mb-[35px] xl:text-2xl xl:px-[7px] xl:mb-2.5"
              >
              ...
              >
                ...
                sollicitudin accumsan nisi a porttitor.
              </p>
              <button
...
const productsLG = computed(() => {
  ...
  for (let i = 0; i < products.value.length; i += 5) {
    chunkedArray.push(products.value.slice(i, i + 5));
  }
  return chunkedArray;
});
...
const productsXL = computed(() => {
  const chunkedArray = [];
  for (let i = 0; i < products.value.length; i += 7) {
    chunkedArray.push(products.value.slice(i, i + 7));
  }
  return chunkedArray;
});
