<template>
    <div class="bg-white rounded-md px-[5px] pt-5 pb-[25px] shadow-card md:pb-5 lg:pb-[25px]">
        ...
        <p class="text-xs text-gray-300 px-2.5 mb-6 md:mb-[15px] lg:mb-6 xl:text-sm xl:mb-[30px]">
            Are you in a hurry? Use the Quick Buy feature!
        </p>
        <div class="grid grid-cols-1 gap-2.5 px-2.5 mb-[25px] max-h-[146px] overflow-y-auto scrollbar-thin md:mb-6 md:max-h-[94px] xl:mb-8">
            <div v-for="(product, index) in products" :key="index" class="flex gap-2.5">
                ...
                <div class="flex bg-[#F5F5F5] rounded-md overflow-hidden">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 22" class="w-[22px] h-[22px]">
                            <path
                                fill="currentColor"
                    ...
                    <button class="flex items-center justify-center bg-gray-200 w-[42px] h-[42px]" @click="product.quantity += 1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 22" class="w-[22px] h-[22px] text-gray-300">
        ...
        <div class="flex gap-2.5 px-2.5">
            ...
            <button class="flex items-center justify-center flex-1 bg-blue rounded text-white py-2">
