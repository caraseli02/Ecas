<template>
  <div
    class="fixed z-[60] top-0 left-0 w-screen h-screen flex flex-col bg-white md:hidden"
  >
    <div
      class="flex items-center justify-between px-5 pt-[15px] pb-[15px] border-b border-gray-200 mb-[15px] md:hidden"
    >
      <div v-if="!selectedCategory" class="text-lg font-semibold text-gray-300">
        Products
      </div>
      <template v-else>
        <button
    ...
    >
      <template v-if="!selectedCategory">
        ...
        >
          <div
            class="flex items-center justify-center w-[34px] h-[34px] rounded bg-gray-200 mr-2"
          >
    ...
    <div v-if="!selectedCategory">
      ...
      <div
        class="bg-blue px-5 pt-[17px] pb-[21px] text-xs font-semibold text-white text-center"
      >
