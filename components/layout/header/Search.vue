<template>
    <div class="relative">
        ...
        >
            ...
            <div @click="handleEnterButton" v-if="!isScrolled" class="flex items-center justify-center bg-blue-500 hover:bg-blue-600 cursor-pointer px-4 py-3">
                <SearchIcon class="w-5 h-5 text-white" />
            </div>
            <UiButton size="icon" variant="ghost" @click="handleEnterButton" v-else class="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer">
