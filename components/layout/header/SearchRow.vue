<template>
  <div class="hidden relative z-20 bg-white py-3 md:block">
    <div class="container">
      <div
        class="relative flex items-center justify-between gap-6 lg:gap-[52px] xl:gap-[162px]"
      >
        ...
        <button
          class="hidden items-center text-gray-300 flex-shrink-0 md:flex xl:hidden"
