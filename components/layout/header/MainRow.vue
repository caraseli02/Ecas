        ...
        <div class="container">
            <div class="relative">
                <div class="flex items-center justify-between">
                    ...
                    />
                    <div
                        class="flex items-center gap-[15px] md:gap-5 xl:gap-[25px]"
                    >
                        <button
                        ...
                        >
                            ...
                            <div class="hidden flex-col text-white md:flex">
                                <div
                                    class="text-xs font-Inter leading-[1.17] mb-0"
                                >
                                    0 items
                                </div>
                                <div
                                    class="text-sm font-Inter font-medium mb-0 lg:text-base"
                                >
                                    0,00 RON
                                </div>
                                <div class="text-xs leading-[1.17]">
                                    (ex VAT)
                                </div>
                            </div>
                        </button>
                ...
                <Transition name="fade">
                    ...
                    >
                        ...
                        >
                            <label
                                class="relative z-10 flex-1 flex items-center"
                            >
                                <SearchIcon
                                ...
                                <form
                                    action=""
                                    @submit.prevent="showMobileSearch = false"
                                >
                                    <input
                                        v-model="searchVal"
                                        ref="searchDOM"
