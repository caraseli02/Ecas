        ...
        >
          <div class="flex items-center">
            <div
              ...
              :class="[isScrolled ? 'md:mr-[29px] lg:mr-0' : 'md:mr-4 lg:mr-6']"
            >
            ...
            <ul
              v-if="!isScrolled"
              class="hidden items-center gap-4 md:flex md:gap-6"
            >
              <li
          ...
          >
            ...
            >
              ...
              <div
                v-if="totalCartPrice"
                class="flex-col text-white flex-shrink-0 ml-6 max-md:hidden"
              >
