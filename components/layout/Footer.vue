<template>
  <footer>
      ...
      <div class="container">
        <div class="text-white md:flex md:items-center md:justify-between">
          <div class="mb-[9px] md:mb-0 xl:flex xl:items-center">
            <div
              class="text-sm font-semibold md:text-base xl:text-2xl xl:font-normal xl:mr-[90px]"
            >
              Subscribe to our Newsletter
            </div>
            <p class="text-xs xl:text-base">
              ...and receive a
              <strong class="font-semibold">10% discount</strong> on your first
              order.
            </p>
          </div>
          <form @submit.prevent class="flex rounded-md shadow-xs">
            ...
            <button
              class="flex items-center flex-shrink-0 bg-blue px-[14px] py-[11px] text-sm font-medium rounded-r-md"
            >
              Subscribe
            </button>
          </form>
    ...
    <div class="bg-[#F5F5F5] pt-[30px] pb-2.5">
      <div class="container">
        <div
          class="mb-[74px] md:flex md:items-start md:gap-[45px] md:mb-8 lg:justify-between lg:mb-[60px]"
        >
          <div class="mb-[30px] md:mb-0">
            <NuxtLink to="/" class="flex">
              <Logo class="w-[121px] mb-5 md:mb-[87px] lg:mb-[67px]" />
            </NuxtLink>
            <div>
              <div class="text-sm mb-2.5 lg:text-base">Follow Us</div>
          ...
          <div
            class="grid grid-cols-2 gap-5 md:flex md:flex-wrap md:gap-x-[30px] lg:gap-x-[50px]"
          >
            <div
              v-for="(items, label, index) in navItems"
              :key="index"
              class="md:max-w-max md:last:ml-[94px] lg:last:ml-0"
            >
              <div class="mb-2 md:mb-[15px]">
                <div
                  class="text-sm font-semibold mb-0.5 md:text-base md:mb-1.5"
                >
                  {{ label }}
                </div>
              ...
              <ul class="grid grid-cols-1 gap-[3px] md:gap-1.5">
                <li
                  v-for="(navItem, navItemIndex) in items"
                  :key="navItemIndex"
                >
                  <NuxtLink
        ...
        <div>
          <p class="text-[15px] text-center text-gray-300">
            &copy; {{ new Date().getFullYear() }} ECAS.RO
          </p>
        </div>
      </div>
    </div>
