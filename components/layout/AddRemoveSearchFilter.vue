  ...
  >
    ...
    >
      ...
      <div class="mb-[34px] lg:mb-[42px]">
        <div
          class="grid grid-cols-[repeat(2,1fr),auto] gap-2 px-6 mb-2 md:px-8"
        >
          <button
            class="flex items-center"
            @click="
              parametersOrder ? (parametersOrder = 0) : (parametersOrder = 1)
            "
          >
            <span class="text-sm font-medium tracking-[0.6px] mr-2">
              Parameters
            </span>
            <CaretIcon
          ...
          <button
            class="flex items-center"
            @click="productsOrder ? (productsOrder = 0) : (productsOrder = 1)"
          >
            <span class="text-sm font-medium tracking-[0.6px] mr-2">
              Products
            </span>
