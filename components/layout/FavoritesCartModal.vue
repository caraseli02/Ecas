<template>
  <div ref="elDOM" class="fixed z-50 top-0 left-0-0 w-screen h-screen">
    <div
      class="relative z-10 flex flex-col ml-auto w-full h-full bg-white md:w-[450px]"
    >
      <button
        class="rounded w-8 h-8 bg-[#F2F2F2] flex items-center justify-center text-gray-100 transition-colors duration-300 mt-5 ml-auto mr-5 mb-2.5 hover:text-gray-300"
      ...
      <div class="px-5">
        <div class="text-sm font-Inter text-gray-300">
          {{
