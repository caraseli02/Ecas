    ...
    <div>
        ...
        >
            <label v-if="!editing" class="flex cursor-pointer mr-2.5">
                ...
                >
                    <CheckIcon v-if="folder.selected" class="w-4 text-white transition-colors duration-300 group-hover:text-blue" />
                </div>
            </label>
            ...
            <button v-else class="text-left" @click="$emit('open')">
                ...
                <div class="flex items-center text-xs leading-tight font-Inter text-gray-300">
