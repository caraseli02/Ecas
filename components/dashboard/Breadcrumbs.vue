    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <div class="flex items-center mb-3">
                <NuxtLink to="/dashboard" class="flex items-center text-gray-300 transition-colors duration-300 hover:text-blue">
                ...
                <NuxtLink
                    ...
                    class="text-xs leading-[1.33] font-medium transition-colors duration-300 hover:text-blue"
                ...
                <template v-if="customer">
                    ...
                    <NuxtLink
                        ...
                        class="text-xs leading-[1.33] font-medium text-blue"
                    >
                        {{ customer }}
                    </NuxtLink>
                </template>
