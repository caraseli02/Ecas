  ...
  >
    ...
    <div class="mt-9 max-md:max-w-full">
      <div class="gap-4 md:gap-5 flex max-md:flex-col max-md:items-stretch">
        <div
          class="flex flex-col items-stretch w-[33%] min-h-[114px] justify-between max-md:w-full max-md:ml-0"
        >
...
<path d="M2.3335 8L13.5535 8" stroke="#5E6278" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        >
          <div
            class="justify-between items-stretch self-stretch flex grow flex-col "
          >
