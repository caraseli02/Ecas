...
<template>
  <section class="flex flex-col items-start self-stretch p-6 bg-white rounded-xl shadow-l max-md:px-5">
    ...
    <hr
      class="self-stretch mt-8 w-full border border-grey-100 border-solid stroke-[1px] stroke-gray-200 max-md:max-w-full" />
    ...
    <UiButton class="min-w-[320px] border-blue-500 mt-8" size="lg" variant="outline">
      <div class="flex gap-2 justify-center">
        <svg class="shrink-0 w-6 aspect-square" width="25" height="25" viewBox="0 0 25 25" fill="none"
          xmlns="http://www.w3.org/2000/svg">
