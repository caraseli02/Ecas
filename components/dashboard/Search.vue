<template>
  <label class="flex relative">
    <input
      ...
      class="w-full border-[1.5px] border-border rounded-lg px-3 pr-10 text-sm placeholder:text-gray-100 transition-colors duration-300 focus:outline-none focus:border-blue"
