<template>
    <div class="flex flex-col bg-white rounded-xl p-4 shadow-xs md:p-6">
        <div class="leading-normal font-semibold mb-4 md:mb-6 xl:mb-10">Customers by Country</div>
        <div class="grid grid-cols-1 md:grid-cols-[auto,auto] md:justify-between xl:flex-1">
            <div class="md:col-start-1 md:row-start-1 md:mr-[60px] xl:mr-10">
                <div class="flex items-center mb-1">
                    ...
                    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7">
                        ...
                        <g mask="url(#mask0_801_26126)">
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 17.1431H6.66667V2.85742H0V17.1431Z" fill="#0A3D9C" />
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                ...
                <div class="text-xs leading-[1.67] text-gray-300 mb-4 md:mb-6">Country with the most customers</div>
            </div>
