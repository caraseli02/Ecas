<template>
  <div class="flex flex-col bg-white rounded-xl p-4 shadow-xs md:p-6">
    ...
    >
      <div
        class="md:col-start-1 md:row-start-1 md:mr-[60px]"
        :class="[loading ? 'md:w-[220px] xl:mr-0' : 'xl:mr-10']"
      >
      ...
      <div
        ...
        :class="[
          loading
            ? 'md:w-[calc(100vw-460px)] xl:w-full'
            : 'max-md:px-4 md:pl-6 md:border-l md:border-gray-200',
        ]"
      >
