        ...
        >
            ...
            <div class="flex-1 overflow-y-auto scrollbar-thin mr-1">
                <div class="grid grid-cols-1 gap-6 pl-4 pr-3 mb-9 md:pl-6 md:pr-3">
                    ...
                    />
                    <FormInput v-model="data.postcode.value" :error="data.postcode.error" label="Postcode" size="lg" placeholder="W1A5AB" />
                    <FormInput
                    ...
                    />
                    <FormInput
                        v-model="data.companyEmail.value"
                        :error="data.companyEmail.error"
                        type="email"
                        label="Company Email"
                        size="lg"
...
onMounted(() => {
    data.value.addressAlias.value = props.address.addressAlias;
    data.value.country.value = props.address.country.value;
    data.value.region.value = props.address.region.value;
    data.value.addressLine1.value = props.address.addressLine1;
    data.value.addressLine2.value = props.address.addressLine2;
    data.value.postcode.value = props.address.postcode;
    data.value.phoneNumber.value = props.address.phoneNumber;
    data.value.companyEmail.value = props.address.companyEmail;
});
</script>
