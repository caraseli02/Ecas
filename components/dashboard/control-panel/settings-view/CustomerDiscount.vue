    ...
    <div class="flex flex-col bg-white rounded-xl p-4 shadow-xs md:p-6 xl:pt-10 xl:shadow-none xl:rounded-none">
        <div class="mb-4">
            <div class="flex items-start justify-between">
                ...
                <button class="flex text-white bg-blue text-xs leading-[1.66] font-semibold rounded-full px-2">10 %</button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-[auto,1fr] lg:grid-cols-1 lg:mt-auto">
            <button
            ...
            <button
                ...
                @click="customerDiscount = customerDiscountBuffer"
            >
...
const customerDiscountBuffer = ref<number | null>(10);
const customerDiscount = ref<number | null>(10);
</script>
