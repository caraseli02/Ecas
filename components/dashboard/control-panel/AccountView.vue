...
import { AddressInterface, ContactDetails, PersonalDetails, UserInterface } from '~/types/auth/user-interface';
...
const getCountryRegion = async (country: any, region: any) => {
    ...
    form.value.country.value = countryRegionObj?.country || { label: '', value: '', icon: '' };
    form.value.region.value = countryRegionObj?.region || { label: '', value: '' };
};
