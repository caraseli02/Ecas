            ...
            <div class="relative">
                ...
                <transition :name="position === 'top' ? 'fade-full' : 'fade-full-neg'">
                    <div
                        ...
                        :class="[position === 'top' ? '-bottom-1 translate-y-full' : '-top-1 -translate-y-full']"
                    >
                        <button
...
const paginationLabel = computed(() => {
    return `Showing ${props.itemsCount === 0 ? 0 : props.atPage * props.perPage - props.perPage + 1} to ${
        props.atPage * props.perPage > props.itemsCount ? props.itemsCount : props.atPage * props.perPage
