    ...
    <div class="flex items-center justify-between w-full">
        ...
        <div v-if="!loading" class="relative flex">
            ...
            <Transition name="fade-bottom">
                <ThreeDotMenu v-if="showOptions" v-click-outside="() => (showOptions = false)" :index="index" :dropdown-top="30" :dropdown-left="25" :profile-button="true"
                :profile="item" :profile-text="'Profile'" :document-button="true" :document-text="'Orders'" :settings-button="true"
                :settings-text="'Settings'" :deactivate-button="true" :deactivate-text="item.active ? 'Lock Account' : 'Unlock Account'" :trash-button="true" :trash-text="'Delete Account'"
                @profile-clicked="showOptions = false" @document-clicked="showOptions = false" @settings-clicked="showOptions = false"
                @deactivate-clicked="
