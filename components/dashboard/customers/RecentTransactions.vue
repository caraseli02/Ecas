<template>
    <div class="relative flex flex-col bg-white rounded-xl p-4 shadow-xs md:p-6">
        ...
        <div class="mb-5">
            <div class="grid grid-cols-[repeat(2,1fr),20px] bg-[#F2F2F2] rounded px-2 py-1 text-sm font-medium leading-[1.57] mb-2">
                <div>Amount</div>
                <div>Status</div>
                <div />
            </div>
            <div
                ...
                :key="index"
                class="grid grid-cols-[repeat(2,1fr),20px] px-2 text-sm font-medium pb-2 last:pb-0"
            >
