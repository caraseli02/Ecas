  ...
  <div class="bg-white rounded-xl p-4 shadow-xs md:p-6">
    <div
      ...
      <div v-if="!error && !emptyData" class="grid grid-cols-2 gap-4 md:flex md:items-center md:max-w-max md:ml-auto">
        <button
            class="flex items-center justify-center col-span-2 w-full bg-blue-500 rounded-lg px-5 py-2 text-white md:max-w-max md:order-3"
        >
          <DownloadIcon class="w-6 h-6 mr-2"/>
          <span class="text-sm leading-[1.71] font-medium"> Download All </span>
        </button>
        <button
            class="flex items-center justify-center w-full bg-[#F2F2F2] rounded-lg px-6 py-2 text-slate-500 md:max-w-max md:order-1"
        >
          <FilterIcon class="w-6 h-6 mr-2"/>
          <span class="text-sm leading-[1.71] font-medium"> Filter </span>
        </button>
        <button
            class="group flex items-center justify-center w-full bg-[#F2F2F2] rounded-lg px-4 py-2 text-slate-500 transition-colors duration-300 md:max-w-max md:order-1"
            @click="clearFilters"
        >
...
v-if="emptyData || error"
         class="flex flex-col items-center justify-center flex-1 my-20 lg:my-[100px] xl:my-[150px]">
