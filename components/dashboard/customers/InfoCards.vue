    ...
    <div class="flex items-start justify-between bg-white rounded-xl p-4 shadow-xs md:p-6">
      <div class="flex items-center">
        ...
        <div>
          ...
          <div v-else-if="emptyData || error.lastOrder" class="text-sm font-medium leading-[1.714] text-gray-100">No
            data available
          </div>
    ...
    <div class="flex items-start justify-between bg-white rounded-xl p-4 shadow-xs md:p-6">
      <div class="flex items-center">
        ...
        <div>
          ...
          <div v-else-if="emptyData || error.totalSpent" class="text-sm font-medium leading-[1.714] text-gray-100">No
            data available
          </div>
    ...
    <div class="flex items-start justify-between bg-white rounded-xl p-4 shadow-xs md:p-6">
      <div class="flex items-center">
        ...
        <div>
          ...
          <div v-else-if="emptyData || error.avgOrderValue" class="text-sm font-medium leading-[1.714] text-gray-100">No
            data available
          </div>
      ...
      <div class="flex items-center">
        ...
        <div>
          ...
          <div
              ...
              class="text-sm font-medium leading-[1.714] text-gray-100">No data available
          </div>
