        ...
        <div class="flex items-start justify-between bg-white rounded-xl p-4 shadow-xs md:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <div v-else-if="!emptyData && !error" class="text-xl font-semibold text-blue leading-[1.2]">#137759224</div>
                </div>
            </div>
        ...
        <div class="flex items-start justify-between bg-white rounded-xl p-4 shadow-xs md:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <SkeletonLoader v-if="isLoading" class="w-[160px] h-6 -mt-1" />
                    <div v-else-if="emptyData || error" class="text-sm font-medium leading-[1.714] text-gray-100">No data available</div>
                    <div v-else-if="!emptyData && !error" class="text-xl font-semibold leading-[1.2]">$138.000,77</div>
                </div>
            </div>
            <WarningIcon v-if="error" class="w-6 h-6" />
        </div>
        <div class="flex items-start justify-between bg-white rounded-xl p-4 shadow-xs md:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <SkeletonLoader v-if="isLoading" class="w-[160px] h-6 -mt-1" />
                    <div v-else-if="emptyData || error" class="text-sm font-medium leading-[1.714] text-gray-100">No data available</div>
                    <div v-else-if="!emptyData && !error" class="text-xl font-semibold leading-[1.2]">$574.00</div>
                </div>
            </div>
            <WarningIcon v-if="error" class="w-6 h-6" />
        </div>
        <div class="flex items-start justify-between bg-white rounded-xl p-4 shadow-xs md:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <SkeletonLoader v-if="isLoading" class="w-[160px] h-6 -mt-1" />
                    <div v-else-if="emptyData || error" class="text-sm font-medium leading-[1.714] text-gray-100">No data available</div>
                    <div v-else-if="!emptyData && !error" class="text-xl font-semibold leading-[1.2]">127</div>
                </div>
            </div>
            <WarningIcon v-if="error" class="w-6 h-6" />
        </div>
