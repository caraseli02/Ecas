...
const fetchInformation = async () => {
  ...
  address.value = (customerInformation.value.accountType === 0 ? customerInformation.value.personalDetails?.address : customerInformation.value.companyDetails?.address);
