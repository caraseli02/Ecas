<template>
  <div class="bg-white rounded-xl p-4 shadow-xs md:p-6">
    <div
      ...
      :class="[emptyData || error ? 'mb-[169px] md:mb-[161px]' : 'mb-8']"
    >
      <div class="flex items-center justify-between">
        <div class="text-sm font-semibold md:text-xl md:leading-[1.2]">
    ...
    <div
      v-if="emptyData || error"
      class="flex flex-col items-center justify-center flex-1 mb-[157px] md:mb-[149px]"
    >
    ...
    <template v-else>
      ...
      >
        ...
        <img
          ...
          :src="Avatar"
          alt="Name"
          class="w-16 h-16 flex-shrink-0 rounded-full object-cover mr-4"
        >
        <div class="md:grid md:grid-cols-[repeat(2,auto)] md:justify-between md:flex-1">
          <SkeletonLoader
            v-if="isLoading"
            class="w-[140px] h-5 mb-2"
          />
          <div
            v-else
            class="flex md:flex-row-reverse"
          >
          ...
          <SkeletonLoader
            v-if="isLoading"
            class="w-[160px] h-5 mb-2 md:w-[180px]"
          />
          <div
            v-else
            class="flex items-center text-sm mb-2 md:order-3 md:mb-0"
          >
          ...
          <div
            v-else
            class="flex items-center text-sm md:order-2 md:mb-2"
          >
      ...
      <div>
        <div class="pb-5 border-b border-gray-200 mb-5">
          <SkeletonLoader
            v-if="isLoading"
            class="w-full h-[304px] md:h-[232px]"
          />
          <template v-else>
            ...
            <div class="grid grid-cols-1 gap-2">
              <div class="grid grid-cols-[140px,1fr] gap-3">
                <div class="text-sm text-slate-500 leading-[1.75]">
                  User Name
                </div>
        ...
        <div class="flex items-start justify-between gap-5">
          <SkeletonLoader
            v-if="isLoading"
            class="w-[120px] h-10 md:w-[160px] md:h-[18px]"
          />
          <div
            v-else
