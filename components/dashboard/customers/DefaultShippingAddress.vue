<template>
    <div class="bg-white rounded-xl p-4 shadow-xs md:p-6">
        <div class="flex items-center justify-between" :class="[emptyData ? 'mb-4' : 'mb-6']">
        ...
        <div v-if="!emptyData" class="flex items-start">
        ...
        <div v-else class="flex items-center md:justify-center">
