...
const backToSelectMenu = async () => {
    let personal = useState<SignupPersonalDetailsType>(
        "signup-personal-details"
    );
...
const registerClassicSignup = async (
    ...
    let fetch = await $api.auth.registerClassic(payload)
...
const registerFirebaseSignup = async (
    ...
    let fetch = await $api.auth.registerFirebase(payload);
            ...
            const businessPayload: SignupBusinessPayload = {
                account: {
                    ...
                    companyDetails: {
                        ...
                        country:
                            businessDetails.value.country.value.value.value,
