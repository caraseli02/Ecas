<template>
    <div class="w-[1392px] max-w-full p-4 mx-auto transition-all duration-300 md:py-6 2xl:px-6">
        <DashboardBreadcrumbs :key="updateBreadcrumbs" title="Customer Profile" :customer="route.params.slug"
                ...
                <div class="grid grid-cols-[repeat(2,auto)] gap-5 text-right">
                    <div class="flex flex-col">
                        ...
                        <div v-if="!isLoading" class="font-semibold leading-tight">
                            <div v-if="emptyData || error" class="text-sm font-medium leading-tight text-gray-500">No data
                                available</div>
        ...
        <div class="grid grid-cols-1 gap-4 md:gap-6">
            <div class="bg-white rounded-xl px-4 py-3 shadow-xs grid grid-cols-2 md:py-2 lg:hidden">
                ...
                <div
                    ...
                    <template v-else>
                        ...
                        <div v-if="emptyData || error" v class="text-sm font-medium leading-tight text-gray-500">No data
                            available</div>
            ...
            <DashboardCustomersTabBar />
            <DashboardCustomersActivity />
            <!-- <DashboardCustomersInfoCards :id="route.params.slug" /> -->
            <div class="flex gap-4 xl:grid-cols-3 xl:grid-rows-[repeat(2,auto)] md:gap-6">
                <DashboardCustomersCustomerInformation :id="route.params.slug"
                    class="xl:col-start-1 xl:row-start-1 xl:row-span-2" />
                <DashboardCustomersRecentlyBought />
                <section class="flex flex-col gap-6">
                    <DashboardCustomersCredit />
                    <DashboardCustomersSupport />
                </section>
            ...
            <div class="flex gap-6 w-full">
                <DashboardCustomersAddressCards />
                <DashboardCustomersPaymentCard />
            </div>
