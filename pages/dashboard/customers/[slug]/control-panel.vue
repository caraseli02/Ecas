<template>
    <div class="w-[1488px] max-w-full p-4 mx-auto transition-all duration-300 md:py-6 2xl:px-6">
        <DashboardBreadcrumbs title="Control Panel" :customer="customer" :panel-view="activeView" :account-type="accountType">
            ...
            <div class="bg-white rounded-xl px-4 py-3 shadow-xs grid grid-cols-2 md:py-2 lg:hidden">
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <div v-if="emptyData || error" v class="text-sm font-medium leading-tight text-gray-100">No data available</div>
...
const setActivePanelHighlight = () => {
    ...
    const index = panelViews.findIndex((panelView) => panelView.path === view) - 1;
