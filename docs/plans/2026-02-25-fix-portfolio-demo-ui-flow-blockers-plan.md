...
- Step 2 “Personal Details” UI is `components/signup/PersonalDetails.vue` and *should* render inputs using:
...
3. **Tablet home “empty” experience**
   - Add/enable a hero/banner section for `md` sizes *or* fix layout/CSS so home sections render and fill the page at 768px.
